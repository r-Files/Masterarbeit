...
\todo{Betrachtet man Fortran sieht man dass die QR-Zerlegung nicht immer neu berechnet wird sondern in jedem Schritt die QR-Zerlegung nur adaptiert wird. Soll das aufgenommen werden?}
