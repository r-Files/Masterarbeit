...
\input{chapters/title_page}         %% include title page
\cleardoublepage					%% starts next text on an odd page 
\input{chapters/affidavit}			%% include the affidavit
\cleardoublepage					%% starts next text on an odd page 
%% include the abstract without chapter number but include it on table of contents:
\addcontentsline{toc}{chapter}{Abstract}	
\include{abstract}					%% inlcude abstract
\addcontentsline{toc}{chapter}{Kurzfassung}
\include{abstract_german}			%% inlcude abstract
\include{chapters/Acknowledgement}  %% include Acknowledgement
...
\include{chapters/introduction}					%% inlcude introduction
\include{chapters/Sensitivities}				%% inlcude Sensitivities
\include{chapters/K-means}						%% inlcude K-means
\include{chapters/NNLS}							%% inlcude non-negative least squares
\include{chapters/Neural_Networks}				%% inlcude neural networks
\include{chapters/Conclusion}					%% include conclusion

\appendix
\include{chapters/appendix_tables}				%% inlcude appendix
\include{chapters/appendix_code}				%% inlcude appendix
